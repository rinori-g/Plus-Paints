...
<header class="fx" id="colorheader">
  <div class="nav__container">
    <div class="nav__mobile">
      <div class="nav__logo">
		  <a href="index.php">
      <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="133" height="101" viewBox="0 0 133 101">
  <defs>
...
if (mq.matches) {
  $(document).ready(function(){       
        ...
        $(document).scroll(function() { 
            ...
            if(scroll_pos > 300) {
                $('.nav__menu li a').css('color', '#000');
            } else {
                $('.nav__menu li a').css('color', '#fff');
            }
        });
    });
} 
